...
class fucker(threading.Thread):
    ...
    def request(self):
        ...
        print("[FUCKED] Mematuk [%s]\r"%(self.url))
    ...
    def run(self):
        ...
        while True:
            try:
                ...
                sys.stdout.write("[FUCKED] Mematuk [%s]\r"%(self.url))
                sys.exit(0)
        sys.exit(0)
...
""")
        ...
        try:
            ...
            print("Usage: python3 TALIBAN.py https://example.com")
